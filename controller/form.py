...
class WebsiteFormInherit(WebsiteForm):
    ...
    def _handle_website_form(self, model_name, **kwargs):
        if model_name == 'help.ticket':
            ...
            partner = request.env['res.partner'].sudo().search([('name', '=', kwargs.get('customer_name')),
            ...
            if 'ticket_attachment' in request.params or request.httprequest.files or data.get('attachments'):
